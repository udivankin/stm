...
// DONE: STORY ID HIGHLIGHTING (maybe like #tag in twitter)
// DONE: IF REJECTED USER SHOULD BE ABLE TO MAKE STORY "STARTED"
// DONE: SQL security - GET only related stories, UPDATE/DELETE only own STORIES, DELETE ONLY OWN COMMENTS
// DONE: EDIT STORIES
// DONE: ADD STORIES
